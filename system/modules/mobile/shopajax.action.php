...
/* 		if(ROUTE_A!='userphotoup' and ROUTE_A!='singphotoup'){
	...
	public function getUserOrderList(){
	   ...
	   $orderlist['listItems']=$this->db->GetList("select * from `@#_shoplist` where q_uid='$member[uid]' order by time desc limit $FIdx,$EIdx " );
		...
		$orderlist['count']=count($orderlist['listItems']);
